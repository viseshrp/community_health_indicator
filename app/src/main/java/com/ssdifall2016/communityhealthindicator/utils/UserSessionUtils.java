...
public class UserSessionUtils {
    public static void saveStudentLoginData(Context mContext, HealthOfficial response) {
        ...
        PreferencesUtils.setString(mContext, AppConstants.MAPPED_COUNTY_ID, response.getMappedCountyId());
        PreferencesUtils.setString(mContext, AppConstants.MAPPED_DISEASE_ID, response.getMappedDiseaseId());
